...
lead: Three architecture families dominate — MLPs for low-dim inputs, ResNets for images, Transformers for sequences. GPT is a causal decoder-only Transformer; ViT applies the Transformer to images via patches.
created: 2026-04-26
modified: 2026-04-27
